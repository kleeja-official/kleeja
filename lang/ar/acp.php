...
return [
    ...
    'FOLDERNAME' => 'إسم مجلد التحميل <small>(يمكنك استخدام {year} و {month} و {day} و {week} و {username})</small>',
    'PREFIXNAME' =>
        'بادئة أسماء الملفات <small>(مثلا : kleeja_ وستضاف قبل اسم كل ملف مرفوع, يمكن استخدام ايضا {rand:4} و {date:d_Y})</small>',
    'FILESNUM' => 'عدد حقول ملفات التحميل',
    'FILESNUM_SHOW' => 'عرض حقول التحميل كلها',
    ...
    'GOOGLEANALYTICS' =>
        '<a href="http://www.google.com/analytics" target="_kleeja"><span style="color:orange">Google</span> Analytics</a>',
    ...
    'E_EXTS' => 'ملاحظة : الأحجام تضبط بالكيلوبايت .',
    ...
    'USERS_UPDATED' => 'تم تحديث بيانات الأعضاء بنجاح.',
    'REPAIRE_TABLE' => '[جداول] تم إصلاح ',
    'REPAIRE_CACHE' => 'تم حذف/تجديد الكاش (الملفات المؤقتة) ...',
    'REPAIRE_F_STAT' => 'تمت إعادة مزامنة إحصائيات الملفات (العدد والحجم الكلي).',
    ...
    'UPDATE_NOW_S' =>
        'انت تستخدم نسخة قديمة من كليجا، قم بالترقية فوراً، نسختك الحالية هي %1$s والنسخة الجديدة هي %2$s .',
    ...
    'USERS_NOT_NORMAL_SYS' =>
        'نظام العضويات الحالي ليس النظام العادي ، أي أن الأعضاء الحاليين لا يمكن تحريرهم من هنا بل من السكربت الذي تم ربط كليجا به، هؤلاء الأعضاء يتبعون لنظام العضويات العادي.',
    ...
    'NO_HTACCESS_DIR_UP' =>
        'لايوجد ملف .htaccess في مجلد التحميل "%s", هذا يعني انه لو تم رفع اكواد خبيثة فسيتمكن المخترق من تشغيلها وقد يحدث امور لاتحمد عقباها!',
    'NO_HTACCESS_DIR_UP_THUMB' =>
        'لايوجد ملف .htaccess في مجلد المصغرات داخل مجلد التحميل "%s", هذا يعني انه لو تم رفع اكواد خبيثة فسيتمكن المخترق من تشغيلها وقد يحدث امور لاتحمد عقباها!',
    ...
    'NOT_EXSIT_USER' =>
        'عفواً العضو الذي تبحث عنه غير موجود في قاعدة البيانات .. ربما أنك تحاول الوصول لعضوية غير موجودة او محذوفة!',
    ...
    'DELF_CAUTION' =>
        '<small class="delf_caution">تحذير : هذه الخاصية قد تكون خطرة عند وضع ارقام صغيرة أو عند إستخدام الروابط المباشرة.</small>',
    'PACKAGE_N_CMPT_KLJ' => 'هذه الإضافة/الستايل غير متوافقة مع إصدار كليجا الذي تستخدمه ! .',
    'PHPINI_FILESIZE_SMALL' =>
        'اعلى حجم يستطيع المستخدمين تحميله لديك "%1$s" بينما إعدادات الـ PHP لديك فيما يتعلق بـ upload_max_filesize هي فقط "%2$s" , قم بسؤال مدير خادمك لرفعها ليستطيع المستخدمين رفع ملفات بالحجم الذي وضعته.',
    'PHPINI_MPOSTSIZE_SMALL' =>
        'بما أنك سمحت بتحميل "%1$s" ملفات دفعة واحدة , فيجب ان تسأل مدير خادمك لرفع قيمة post_max_size من اعدادات ال PHP بالخادم لما يقارب "%2$s" لتضمن لكليجا عمل أفضل.',
    'NUMPER_REPORT' => 'البلاغات',
    'NO_UP_CHANGE_S' => 'لا يوجد أي تغيير في البيانات , وبالتالي لم يتم تحديث البيانات !.',
    'ADD_HEADER_EXTRA' => 'هيدر إضافي',
    'ADD_FOOTER_EXTRA' => 'فوتر إضافي',
    'ADMIN_USING_IE6' =>
        'أنت تستخدم متصفح "انترنت اكسبلور قديم" هذا رغم انك صاحب موقع وتعرف اكثر ممايعرفه المستخدمون العاديون ! قم بترقية متصفحك او استخدم فيرفوكس الآن.',
    'T_CLEANING_FILES_NOW' =>
        'جاري تنفيذ عملية حذف الملفات الخاملة حالياً على دفعات تفادياً للضغط ,وقت العملية يعتمد على عدد الملفات وحجمها ...',
    'DEPEND_ON_NO_STYLE_ERR' => 'هذا الستايل يعتمد على ستايل "%s" غير الموجود لديك ضمن الستايلات !.',
    'PLUGINS_REQ_NO_STYLE_ERR' =>
        'هذا الستايل يتطلب ان تكون الإضافة/الاضافات [ %s ] مثبتة لديك , ثبتها وحاول من جديد !.',
    ...
    'COMMA_X' =>
        '<p class="live_xts">افصل بين الامتدادات باستخدام الفاصلة (<span style="font-size:large"> , </span>)</p>',
    'NO_SEARCH_WORD' => 'لم تقم بكتابة كلمة بحث !',
    'USERSECTOUPLOAD' => 'عدد الثواني بين كل عملية رفع',
    'ADM_UNWANTED_FILES' =>
        'يبدو انك قمت بالترقية من نسخة سابقة وبسبب اختلاف اسماء بعض الملفات ستلاحظ وجود ازرار متكررة بلوحة التحكم . <br /> لحل المشكلة قم بإزالة كافة الملفات في المسار "includes/adm" واعادة رفعها من جديد. ايضا قم بحذف ملف admin.php من المجلد الرئيسي اذا وجد.',
    'HTML_URLS_ENABLED_NO_HTCC' =>
        'لقد قمت بتفعيل روابط الهتمل ولكنك نسيت أن تقوم بإعادة تسمية الملف htaccess.txt في مجلد كليجا الرئيسي  ليصبح ".htaccess". اذا لم تفهم شيئاً من هذا الكلام قم بالسؤال في الدعم الفني لكليجا او قم بتعطيل روابط الهتمل .',
    'PLUGIN_CONFIRM_ADD' =>
        'انتبه, الاضافات هي تعديلات برمجية على كليجا و قد تكون ضارة أحياناً , لذا ان كنت غير متأكد من مصدر الإضافة ولم تقم بتحميلها من موقع كليجا فالافضل ان تراجع نفسك الآن . ',
    'LOADING' => 'جاري التنفيذ',
    'WELCOME' => 'مرحباً',
    'ENABLE_CAPTCHA' => 'تفعيل كود الامان بكليجا',
    'NO_THUMB_FOLDER' =>
        'يبدو ان المصغرات مُفعلة لديك ولكن في نفس الوقت مجلد %s غير متوفر مما يمنع عملية انشاء المصغرات, قم بإنشاء المجلد.',
    'DELETE_EARLIER_30DAYS' => 'حذف ما مضى عليه 30 يوماً',
    'DELETE_ALL' => 'حذف الكل',
    'DELETE_PROCESS_QUEUED' =>
        'تم اضافة عملية الحذف لقائمة الانتظار, سيتم تنفيذها تدريجياً لكي لايتم زيادة الحمل على الخادم.',
    'DELETE_PROCESS_IN_WORK' => 'جاري تنفيذ عملية الحذف التدريجية حالياً ...',
    'SHOW_FROM_24H' => 'عرض آخر 24 ساعة',
    'THUMB_DIS_LONGTIME' =>
        'المصغرات معطلة, هذا سيجعل كليجا تقوم بتصغير الصور الكبيرة لك هنا, وبالتالي ستاخذ وقتاً طويلاً لعرضها, فعل المصغرات الآن.',
    ...
    'DEFAULT_GRP_NO_DEL' =>
        'لايمكن حذف المجموعة الافتراضية, قم بتغيير المجموعة الافتراضية لمجموعة اخرى ثم قم بحذف هذه المجموعة من جديد!.',
    ...
    'IMAGEFOLDEREXTS' =>
        'صيغ الصور والملفات المباشرة - مثل: mp3, mp4, swf (لن تمر على صفحة إنتظار وسيتم تخزينها بمجلد مختلف أن أردت)',
    ...
    'WHY_SYNCING' =>
        'كليجا تستخدم التزايد التلقائي بحيث لايتم حساب الاعداد كل مرة لزيادة اداء كليجا, استخدم هذه الميزة بعد الترقية او عندما يتم طلب ذلك منك.',
    'REPAIR_DB_TABLES' => 'إصلاح جداول قاعدة البيانات',
    'NO_RESULT_USE_SYNC' =>
        'لايوجد نتائج, اذا كان المركز جديد فهذا امر عادي. <br/> اما اذا كنت قد قمت بالترقية مؤخرا فقم بعمل مزامنة من صفحة الصيانة لعدد الملفات او الصور.',
    'ADVICE_CRON_LINK' => 'يفضل وضع رابط طابور المهام المتكررة كعملية Cron كل ساعة أو ساعتين',
    'UPLOAD_LOCAL_PC' => 'رفع من جهازك',
    'NO_ZIP_ARCHIVE' => 'يبدو أن ZipArchive ليس متوفراً على خادمك، قم بتثبيته فهو من المتطلبات.',
    ...
    'SESSION_ENDED' => 'انتهت الجلسة، هل تريد تسجيل الدخول من جديد؟',
    'CUSTOMIZATION' => 'تخصيص',
    'SHOW' => 'عرض',
    'HIDE' => 'إخفاء',
    'VIEW' => 'إستعراض',
    ...
    'PHP_8_REQUIRED' => 'يلزم توفر PHP 8 للترقية إلى الإصدارات التالية',
    'PDO_EXT_REQUIRED' => 'يلزم تثبيت ملحق PDO للترقية إلى الإصدارات التالية',
];
