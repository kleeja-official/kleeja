...
return array(
	...
	'DELF_CAUTION'				=> '<small class="delf_caution">تحذير : هذه الخاصيه قد تكون خطره عند وضع ارقام صغيره أو عند إستخدام الروابط المباشرة.</small>',
	...
	'ADMIN_USING_IE6'			=> 'أنت تستخدم متصفح "انترنت اكسبلور قديم" هذا رغم انك صاحب موقع وتعرف اكثر ممايعرفه المستخدمون العاديون ! قم بترقيه متصفحك او استخدم فيرفوكس الآن.',
	...
	'IMAGEFOLDEREXTS'			=> 'صيغ الصور والملفات المباشره - مثل: mp3, mp4, swf (لن تمر على صفحة إنتظار وسيتم تخزينها بمجلد مختلف أن أردت)',
