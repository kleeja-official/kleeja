...
return [
    ...
    'REGISTER_SUCCESFUL' => 'شكراً لتسجيلك معنا',
    ...
    'GET_LOSTPASS_MSG' =>
        "لقد قمت بطلب إستعادة كلمة مرورك , لكن لتجنب السبام قم بالضغط على الرابط التالي لتأكيدها : \r\n %1\$s \r\n كلمة المرور الجديدة : %2\$s",
    'CANT_SEND_NEWPASS' => 'خطأ.. لم يتم إرسال كلمة المرور الجديدة!',
    'OK_SEND_NEWPASS' => 'تم إرسال كلمة المرور الجديدة..',
    'OK_APPLY_NEWPASS' => 'تم ضبط كلمة المرور الجديدة , يمكنك الآن الدخول بها .',
    ...
    'CANT_DIR_CRT' => 'لم يتم إنشاء المجلد تلقائياً.. قم بإنشائه يدوياً',
    ...
    'BITE' => 'بايت',
    'KILOBYTE' => 'كيلوبايت',
    'NOT_SAFE_FILE' => 'نظام كليجا اكتشف أن الملف "%s" غير آمن ويحتوي على أكواد خبيثة .. !!',
    ...
    'EDIT_U_AVATER_LINK' =>
        'لتغيير الصورة الرمزية, قم بالدخول الى الموقع %1$s" اضغط هنا "%2$s والتسجيل بالبريد الخاص بك. ',
    ...
    'REMME' => 'تذكرني',
    'REMME_EXP' => 'علّم هذا الخيار إن كان جهازك غير مشترك مع غيرك',
    'HOUR' => 'ساعة',
    '5HOURS' => '5 ساعات',
    'DAY' => 'يوم',
    'WEEK' => 'اسبوع',
    ...
    'TIME_AM' => 'ص',
    'NOT_YET' => 'ليس بعد!',
    'NOT_FOUND' => 'إما انه غير موجود , او تم حذفه من قبل المستخدم نفسه , او الادارة , او هناك خطأ في فتح الملف!',
