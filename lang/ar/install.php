...
return [
    ...
    'INST_GOOD_GO' => 'تم التأكد من المتغيرات والإتصال والتراخيص .. تابع',
    'INST_MSGINS' => 'يمكنك تحميل ماتشاء وفق المسموح به .. شكراً لزيارتك',
    ...
    'INST_END' =>
        'معالج التثبيت انتهى، يجب الآن حذف مجلد INSTALL <span style="color:red">(الموقع لن يعمل في حال وجود المجلد)</span>',
    'INST_NOTE_D' =>
        'أي ملاحظات أو مشاكل تتعلق بأداء كليجا، نرجو التبليغ عبر <a href="https://github.com/kleeja/kleeja/issues">مركز الأخطاء</a>',
    'INST_FINISH_ERRSQL' =>
        'هناك مشكلة تعيق التثبيت، تأكد من حساب مستخدم القاعدة وحاول مجدداً او استفسر من مطوري كليجا',
    ...
    'DB_INFO_NW' =>
        'أدخل بيانات القاعدة بشكل صحيح ، واضغط على (تصدير الملف)وسيقوم المعالج بتصدير ملف config.php لتضعه في مجلد السكربت الرئيسي  كما يتضح لك بالصورة!',
    ...
    'FUNCTION_DISC_GD' =>
        'دالة imagecreatetruecolor هي من دوال مكتبة GD التي تستخدم لإنشاء مصغرات الصور والكود الأمني , عدم وجود الدالة غالبا يعني عدم تواجد مكتبة GD على السيرفر .. ',
    ...
    'ZIPARCHIVE_LIB' =>
        '<span style="color:red;padding:0 6px">مكتبة ZipArchive  غير متوفرة في خادمك !</span><br /> هذه المكتبة مهمة لفك الإضافات والترقية لنسخ جديدة من كليجا!',
    ...
    'IS_IT_OFFICIAL_DESC' =>
        'يصلنا الكثير من الشكاوي والتساؤلات عن سبب بعض المشاكل التي تحدث في بعض النسخ ولا نستطيع معرفة المشكلة غالباً , لكن بعد البحث وجدنا ان هناك نسخاً يتم تحميلها من مواقع اخرى غير رسمية وتكون اما معدلة بطريقة بدائية او مزروع داخلها اكواد خبيثة.<span class="sure">لذا , هل انت متأكد من ان نسختك هذه تم تحميلها من الموقع الرسمي : kleeja.net ؟</span>',

    'INST_WHAT_IS_KLEEJA_T' => 'ماهي كليجا ؟',
    'INST_WHAT_IS_KLEEJA' =>
        'Kleeja  تنطق عربياً  "كليجا" ! وكتعريف مبسط "كليجا" سكربت رفع ملفات مجاني يأتي مع خصائص فريدة لمساعدة أصحاب المواقع بإمتلاك مركز تحميل قوي ويعتمد عليه  , والحقيقة أن "كليجا" سكربت ضخم الامكانيات سهل الإدارة تم بناء نظام الحماية على مستوى عالي ويملك من الأنظمة المعقدة ما يؤمن لموقعك الحماية التامة بإذن الله !',
    'INST_SPECIAL_KLEEJA' => 'من أهم مميزات كليجا !',
    'INST_WHAT_IS_KLEEJA_ONE' =>
        '1. نظام أعضاء قوي تستطيع ربطه بأغلب السكربتات المستخدمة في المواقع الاجتماعية .<br />2. لوحة تحكم مذهلة ليس فقط للتحكم بالملفات ولكن للتحكم  بكل صغيرة وكبيرة  .<br />3. نظام الستايلات البسيط يجعلك تستطيع ان تصنع ستايلك بنفسك.<br />4. مع كليجا ونظام الإضافات البرمجية تستطيع أن تقوم بتركيب الكثير من الاضافات الرائعة .<br />5. ليس هذا فحسب بل كليجا تملك الكثير .. لتعرف أكثر رجاءً قم بزيارة صفحة <a target="_blank" href="https://kleeja.net/">معلومات ومميزات</a> .',
    'YES' => 'نعم',
    'NO' => 'لا',

    'KLEEJA_TEAM_MSG_NAME' => 'فريق تطوير كليجا',
    'KLEEJA_TEAM_MSG_TEXT' =>
        "شكراً لاختيارك سكربت الرفع الأول كليجا\n نتمنى حقا ان تستمتع بالسكربت .\nلا تنسَ زيارة https://kleeja.net للاطلاع على التحديثات القادمة، وللإبلاغ عن الأخطاء والمشاكل قم بزيارة صفحة المشاكل: https://github.com/kleeja/kleeja/issues",
    'EXTENSION_PDO_EXISTS' =>
        'يُستخدم امتداد PDO للاتصال بقواعد بيانات متعددة باستخدام نفس الشيفرة البرمجية، وللتحقق من صحة استعلامات SQL قبل تنفيذها',
