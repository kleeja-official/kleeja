...
return [
    ...
    'FOLDERNAME' =>
        'Folder name for uploaded files <small>(you can use {year}, {month}, {day} ,{week} ,{username})</small>',
    ...
    'USERS_UPDATED' => 'Users have been updated successfully.',
    'REPAIRE_TABLE' => '[Tables] Repaired. ',
    'REPAIRE_CACHE' => 'Cache has been deleted/refreshed.',
    'REPAIRE_F_STAT' => 'Files statistics (total number and size) have been re-synced.',
    ...
    'UPDATE_NOW_S' =>
        'You are using an old version of Kleeja. Update Now. Your current version is %1$s and the latest one is %2$s',
    ...
    'CONFIG_WRITEABLE' =>
        'The file config.php is currently writable, We strongly recommend that it be changed to 640 or at least 644.',
    'USERS_NOT_NORMAL_SYS' =>
        'The current users system is not the normal one, which means that the current users cannot be edited from here but from the script that was integrated with Kleeja, those users use the normal membership system.',
    'DIMENSIONS_THMB' => 'Thumbs dimensions',
    'ADMIN_DELETE_FILE_OK' => 'All the user files have been deleted.',
    'ADMIN_DELETE_FILES' => 'Delete all user files',

    'BCONVERTER' => 'Byte Converter',
    'NO_HTACCESS_DIR_UP' =>
        'No .htaccess file was found in "%s" folder, Which means if malicious codes were injected a hacker can do damage to your website!',
    'NO_HTACCESS_DIR_UP_THUMB' =>
        'No .htaccess file was found in Thumbs folder "%s", Which means if malicious codes were injected a hacker can do damage to your website!',
    ...
    'ADMIN_DELETE_FILES_OK' => '%s file(s) deleted successfully',
    'ADMIN_DELETE_FILES_NOF' => 'No files to delete',
    'NOT_EXSIT_USER' =>
        'Sorry, the user you are looking for does not exist in our database... perhaps you are trying to reach a deleted membership !!!!',
    ...
    'DELF_CAUTION' =>
        '<small class="delf_caution">Caution: might be dangerous when using small numbers or using direct form of URLS.</small>',
    'PACKAGE_N_CMPT_KLJ' => 'This plugin/style is not compatible with your current version of Kleeja.',
    'PHPINI_FILESIZE_SMALL' =>
        'Maximum file size allowed for your service is "%1$s" while <b>upload_max_filesize</b> in your hosts PHP settings is set to "%2$s", update it so that your chosen size can be applied.',
    'PHPINI_MPOSTSIZE_SMALL' =>
        'You have allowed the upload of "%1$s" files at once, You need to use a bigger value for <b>post_max_size</b> in your servers PHP settings, something like "%2$s" for a better performance.',
    ...
    'T_CLEANING_FILES_NOW' =>
        'Deleting Un-downloaded files, The process could take a while depending on the size and number of the files.',
    'DEPEND_ON_NO_STYLE_ERR' => 'This style is based on the "%s" style which you don\'t seem to have',
    ...
    'ADM_UNWANTED_FILES' =>
        'You seem to have upgraded from a previous version, and because some file names are different now, you\'ll notice duplicated buttons in control panel. <br /> To solve this, remove all the files in "includes/adm" directory and re-upload them. Also delete the admin.php file from the root directory if it exists.',
    'HTML_URLS_ENABLED_NO_HTCC' =>
        'You have enabled the rewrite URLs, but you seem to have forgotten to rename .htaccess.txt in Kleeja\'s root directory to ".htaccess", however, if you don\'t know what I\'m talking about, go ask for Kleeja\'s support or simply disable the rewrite urls feature.',
    'PLUGIN_CONFIRM_ADD' =>
        'Caution: plugins make changes to Kleeja functionality, and they could be harmful at times. so be sure to check the plugin source and make sure that it is an official Kleeja plugin.',
    'LOADING' => 'Loading',
    'WELCOME' => 'Welcome',
    'ENABLE_CAPTCHA' => 'Enable Captcha in Kleeja',
    'NO_THUMB_FOLDER' => 'It seems you enabled Thumbs but at the same time the folder %s does not exist! Create it.',
    'DELETE_EARLIER_30DAYS' => 'Delete items older than 30 days',
    'DELETE_ALL' => 'Delete all',
    'DELETE_PROCESS_QUEUED' =>
        'The delete process has been added to the waiting list to execute it gradually to reduce the load.',
    'DELETE_PROCESS_IN_WORK' => 'Currently, the delete process is executing ...',
    'SHOW_FROM_24H' => 'Show past 24 hours',
    'THUMB_DIS_LONGTIME' =>
        'Thumbs are disabled, this will force Kleeja to resize every image to be small here, and cost you time and bandwidth!. Enable thumbs now.',
    ...
    'GROUP_IS_DEFAULT' => 'This group is default at registration',
    ...
    'GROUP_DELETED' => 'Group "%1$s" has been deleted and its users moved to group "%2$s".',
    'NO_MOVE_SAME_GRP' => 'You can not move the users to the same group!.',
    'DEFAULT_GRP_NO_DEL' =>
        'You can not delete this group because it is the current default group, change the default group then try to delete it!.',
    ...
    'IMAGEFOLDEREXTS' =>
        'Files\' Extensions of Live links feature (No waiting page of these files, and has separated folder) (ex: swf, mp4, mp3)  ',
    ...
    'WHY_SYNCING' =>
        'Kleeja uses auto increment to not perform calculation of total numbers every time, this improves Kleeja performance. Use this after upgrade or when Kleeja asks you to.',
    'REPAIR_DB_TABLES' => 'Repair database tables',
    'NO_RESULT_USE_SYNC' =>
        'There are no results, if you just installed Kleeja then that\'s OK. <br /> If you just made an upgrade, then go to "Maintenance page" then do a "re-sync" for files or images.',
    ...
    'EXTRACT_ZIP_FAILED' =>
        'We encountered a problem while extracting this archive file, make sure it\'s a valid zip file, and that "%s" folder is writable',
    ...
    'KLJ_VER_NO_PLUGIN' => 'This plugin/style can work on Kleeja version %1$s up to version %2$s.',
    'VERSION' => 'Version',
    'DEVELOPER' => 'Developer',
