...
return [
    ...
    'ADM_UNWANTED_FILES' =>
        'You seem to have upgraded from a previous version, and because some file names are different now, you\'ll notice duplicated buttons in control panel. </ br> to solve this, remove all the files in "includes/adm" directory and re-upload them.',
    'HTML_URLS_ENABLED_NO_HTCC' =>
        'you have enabled the rewrite URLs, but you seem to have forgot to rename .htaccess.txt in Kleeja\'s root directory to ".htaccess", however, if you don\'t know what I\'m talking about, go ask for Kleeja\'s support or simply disable the rewrite urls feature.',
    'PLUGIN_CONFIRM_ADD' =>
    ...
    'THUMB_DIS_LONGTIME' =>
        'Thumbs are disabled, this will force Kleeja to resize every images to be small here, and cost you time and bandwidth!. Enable thumbs now.',
    ...
    'DEFAULT_GRP_NO_DEL' =>
        'You can not delete this group becuase it is the current default group, change the default group then try to delete it!.',
    ...
    'WHY_SYNCING' =>
        'Kleeja uses auto increment to not perform calculation of total numbers everytime, this rises Kleeja performance. Use this after upgrade or when Kleeja asks you to.',
    'REPAIR_DB_TABLES' => 'Repair Data base tables',
    'NO_RESULT_USE_SYNC' =>
        'There are no results, if you just installed Kleeja then that ok. <br /> If you just made an upgrade, then go to "Mentenance page" then do a "re-sync" for files or images.',
    ...
    'EXTRACT_ZIP_FAILED' =>
        'We encounter a problem while extracting this archive file, make sure it\'s a valid zip file, and that "%s" folder is writable',
