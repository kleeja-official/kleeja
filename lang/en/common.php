...
return [
    ...
    'SIZES_EXCCEDED' => 'We have run out of space ... we will be back soon.',
    ...
    'REGISTERED_BEFORE' => 'You have already registered.',
    'REGISTER' => 'Register',
    'EMAIL' => 'Email address',
    'VERTY_CODE' => 'Security code',
    'WRONG_EMAIL' => 'Incorrect email address!',
    'WRONG_NAME' =>
        'The username must be 4 to 25 characters, and without spaces or special chars (only _- are allowed)!',
    ...
    'REGISTER_SUCCESFUL' => 'Thank you for registering.',
    'LOGOUT_SUCCESFUL' => 'Logged out successfully.',
    'LOGOUT_ERROR' => 'Logout Error!',
    'DEL_SELECTED' => 'Delete selected',
    'DEL_ALL' => 'Delete all my files',
    'ALL_DELETED' => 'All files have been deleted.',
    'NO_FILES_DELETE' => 'There are no files to delete.',
    ...
    'SAME_FILE_EXIST' => 'File "%s" already exists, rename it and try again.',
    ...
    'URL_CANT_GET' => 'Error while fetching the file from the URL..',
    'ADMINCP' => 'Control Panel',

    'GO_BACK_BROWSER' => 'Go back',
    'U_R_BANNED' => 'Your IP/membership has been banned.',
    'U_R_FLOODER' => 'You have exceeded the allowed number of page views in a short time (anti-flood protection) ...',
    'YES' => 'Yes',
    'NO' => 'No',
    'LANGUAGE' => 'Language',
    'STYLE' => 'Style',
    ...
    'EDIT_U_AVATER' => 'Edit your avatar',
    'EDIT_U_AVATER_LINK' =>
        'To change your avatar, go to this site %1$s" Click Here "%2$s and register with the same email address you use here.',
    ...
    'INVALID_GET_KEY' =>
        'Sorry, The requested link is expired, and is blocked for security reason, go back and try again.',
    ...
    'DELETE_INSTALL_FOLDER' =>
        'To start using Kleeja, delete "install" folder, Kleeja will never work while this folder exists.',
    ...
    'NOT_YET' => 'Not yet!',
    'NOT_FOUND' =>
        'This file does not exist. It was either deleted by the user or the administrator, or there was an error opening the file!',
    'TIME_ZONE' => 'Time zone',
    'OR' => 'or',
    'AND' => 'and',
    'CHANGE' => 'Change',
