...
return [
    ...
    'PACKAGE_REMOTE_FILE_MISSING'                  => 'بسته "٪ s" در فروشگاه خارجی کلیگا در دسترس نیست!',
    'STORE_SERVER_ERROR'                           => 'هنگام برقراری ارتباط با سرور فروشگاه خارجی کلیگا با خطایی مواجه شدیم ...',
    'INSTALLED_PLUGINS'                            => 'افزونه های نصب شده',
    'LOCAL_PLUGINS'                                => 'برنامه های افزودنی محلی (نصب نشده است)',
    'KLEEJA_STORE'                                 => 'فروشگاه کلیگا',
    'KLJ_VER_NO_PLUGIN'                            => 'این افزونه / سبک می تواند بر روی نسخه کلیگا%1$s تا%2$s کار کند.',
    'VERSION'                                      => 'رهایی',
    ...
    'UPDATE_PROCESS_DONE'                          => 'کلیگا با موفقیت به نسخه `%s` به روز شد ...',
    'UPDATE_PROCESS_STEP1'                         => 'بسته بندی آخرین نسخه کلیگا را به ارمغان آورد ...',
